#' @title designAnal
#' @description Analysis of efficiency gains from stratified randon versus
#' simple random with "BIOsurvey" or "PEDstrata" package. This function needs
#' work! :(
...
designAnal<-function(restrat.dat,restrat.areas,original.strata=NULL,original.areas=NULL,years=2007:1981,plot=T,domain=T,biomass=F){
	...
	if (!requireNamespace("PEDstrata", quietly=TRUE)) {
	  stop("Find and Install PEDstrata Package (good luck:)")
	}
